...
import { NFTProject } from '@/app/constants/types';
import NFTInprogressCard from '../Cards/NFTInprogressCard';
import UserInprogressNftCard from './Cards/UserInprogressNftCard';

const UserInprogressNfts = () => {
  ...
  return (
    <section className="flex flex-col justify-center ">
      <div className="w-full m-auto text-center mb-10">
        <h3 className="text-7xl font-bold">InProgress</h3>
      </div>
...
export default UserInprogressNfts;
