                ...
                <div className=' flex flex-col gap-10 w-[1150px] mx-auto  '>
                    <div className='info1 flex flex-row gap-16' >
                        ...
                        <div className='detail1'>
                            <p className=' mb-12'>The next tier system of Venpad proposes a 9 tier system that works according to “Pool Weight” system per wallet in each tier; rather than our old broken system where we were dividing the allocations in between 3 tiers regardless of how many wallets there were in each tier.</p>
